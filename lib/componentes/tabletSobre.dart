...
class TabletSobre extends StatefulWidget {
  const TabletSobre({super.key});

  @override
  State<TabletSobre> createState() => _TabletSobreState();
}

class _TabletSobreState extends State<TabletSobre> {
  @override
